...
## Limitations
* My sampe size was a limitation, as the 1940 decade is included but played fewer games against random teams, which can skew that decades results and make the entire markdown more volatile
